import { Card, CardContent, Fab, Grid, makeStyles, Typography } from "@material-ui/core"
            ...
            <Grid item>
                <Card>
                    ...
                    <CardContent className={classes.cardContent}>
                        <Typography gutterBottom variant="h5" align='center' className={classes.goodsTitle}>
                            Karma Hookah</Typography>
                        <div className={classes.goodsVariability}>
                            {category === 'hookah' ?
                                <div className={classes.hookahVariability}>
                                    <ToggleButtonGroup size="medium" >
                                        <ToggleButton value="WithoutFlask">
                                            Без колбы
                                            </ToggleButton>
                                        <ToggleButton value="withFlask">
                                            С колбой
                                             </ToggleButton>
                                    </ToggleButtonGroup>
                                    <ToggleButtonGroup size="medium" >
                        ...
                        <Grid container justify='space-between'>
                            ...
                            <Grid item>
                                <Fab color='primary' variant='extended'><AddIcon />Добавить</Fab>
                            </Grid>
                        </Grid>
                    </CardContent>
                </Card>
